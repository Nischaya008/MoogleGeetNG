...
require('./utils/passportGoogle'); // Passport Google config
...
// After Express and before listen: HTTP and Socket.io Bootstrap
...
const io = new Server(http, {
  ...
  // path: '/socket.io', // ensure frontend matches this; default is '/socket.io'
});
...
module.exports.SOCKET_USER = SOCKET_USER; // export for external test/debug if needed
module.exports.SOCKET_ROOM = SOCKET_ROOM;
module.exports.socketsForUser = socketsForUser;
...
// --- Start server (after all handlers, replace app.listen)

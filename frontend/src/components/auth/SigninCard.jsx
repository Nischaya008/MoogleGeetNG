...
export default function SigninCard({ signinD, setSigninD, loading, onSubmit, onSwitchToSignup, onGoogle, msg, err }) {
    return (
        <form action="" className="form" onSubmit={onSubmit}>
            ...
            <div className="row">
                <input
                    ...
                    name="identity"
                    required
                    value={signinD.identity}
                    onChange={(e) => setSigninD(i => ({ ...i, identity: e.target.value }))}
                    disabled={loading}
                ...
                <input
                    ...
                    name="password"
                    required
                    value={signinD.password}
                    onChange={(e) => setSigninD(i => ({ ...i, password: e.target.value }))}
                    disabled={loading}
